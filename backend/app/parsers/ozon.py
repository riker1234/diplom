...
_MOUSE_KEYS = {
    ...
    "connection_types": {"тип соединения", "тип подключения",
                         "тип соединения мыши", "тип подключения мыши",
                         "тип беспроводного соединения"},
    "interface":        {"интерфейс подключения", "интерфейс", "интерфейс мыши",
                         "подключение", "тип интерфейса"},
...
_KEYBOARD_KEYS = {
    ...
    "connection_types":     {"тип подключения", "тип соединения",
                             "тип подключения клавиатуры", "подключение"},
...
_HEADPHONES_KEYS = {
    ...
    "connection_types":   {"тип подключения", "подключение",
                           "тип беспроводной связи", "тип соединения"},
    "interface":          {"интерфейс", "интерфейс подключения"},
...
_MICROPHONE_KEYS = {
    ...
    "connection_types": {"тип подключения", "подключение"},
    "interface":        {"интерфейсы и разъемы", "интерфейс",
                         "разъём", "тип разъёма"},
