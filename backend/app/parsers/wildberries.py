...
_MOUSE_KEYS = {
    ...
    "connection_types": {"тип подключения мыши", "тип подключения", "интерфейс",
                         "тип соединения мыши", "тип соединения", "подключение",
                         "интерфейс подключения", "тип беспроводного соединения"},
...
_KEYBOARD_KEYS = {
    ...
    "connection_types":     {"тип подключения клавиатуры", "тип подключения", "интерфейс",
                             "подключение", "интерфейс подключения", "тип соединения"},
...
_HEADPHONES_KEYS = {
    ...
    "connection_types":   {"тип подключения наушников", "тип подключения", "интерфейс",
                           "подключение", "тип соединения", "интерфейс подключения",
